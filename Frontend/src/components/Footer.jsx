    ...
    <div className="row">
      <div className="col-4">
        ...
        <div>
          ...
          <a href="tel:+0123456789" className="mt-3 d-block mb-1 text-white">
            +0123456789
          </a>
          <a href="mailto:arwa@gmail.com" className="mt-2 d-block mb-0 text-white">
          arwa@gmail.com
          </a>
    ...
    <BsYoutube className="fs-4" />
      ...
      <div className="col-3">
        ...
        <div className="footer-link d-flex flex-column">
          ...
          <Link className="text-white py-2 mb-1" to="/termsconditions">Terms & Conditions</Link>
      ...
      <div className="col-3">
        ...
        <div className="footer-link d-flex flex-column">
          ...
          <Link className="text-white py-2 mb-1" to="/faqs">FAQs</Link>
      ...
      <div className="col-2">
        ...
        <div className="footer-link d-flex flex-column">
          <Link className="text-white py-2 mb-1" to="/laptops">Laptops</Link>
          <Link className="text-white py-2 mb-1" to="/accessories">Accessories</Link>
          <Link className="text-white py-2 mb-1" to="/smartphones">Smartphones</Link>
          <Link className="text-white py-2 mb-1" to="/tablets">Tablets</Link>
          <Link className="text-white py-2 mb-1" to="/tablets">Watches</Link>
        </div>
      </div>
    </div>
  </div>
